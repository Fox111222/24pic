...
cc.Class({
    ...
    setModelID: function(num) {
        ...
        if(this.modelID == 0) {
            ...
            this.walkAnim = "2archer_walk";
            this.jumpAnim = "2archer_Jump";
            this.idleAnim = "2archer_Idle";
            this.dieAnim = "2archer_Death";
            this.throwPreAnim = "2archer_Hit";
            this.throwAnim = "2archer_attack";
         }
         else if(this.modelID == 2){
            this.walkAnim = "archer_walk";
            this.jumpAnim = "archer_Jump";
            this.idleAnim = "archer_Idle";
            this.dieAnim = "archer_Death";
            this.throwPreAnim = "archer_Hit";
            this.throwAnim = "archer_attack";
         }
    },
