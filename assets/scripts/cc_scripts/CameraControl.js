cc.Class({
    ...
    update: function (dt) {
        if(this.inc){
            this.node.position.z=20
            cc.log("dddddddddddddddddd",this.node.position.z)
        }
    ...
    */
    ...
    lateUpdate: function (dt) {
        ...
        //this.camera.zoomRatio = 0.5 + (0.5 - ratio) * 0.5 ;
        this.camera.zoomRatio = 0.5;
        //cc.log("afterafterafterafter",this.node.position.x,this.node.position.y,this.node.position.z)
       // this.testDraw();
    },
